...
WHERE   utilisateur.id_utilisateur=niveau_utilisateur.id_utilisateur AND
    competence.id_competence=niveau_utilisateur.id_competence AND
    niveau.id_niveau=niveau_utilisateur.id_niveau;